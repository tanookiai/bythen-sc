...
describe ("generating random amount of bid..", function() {
    async function deployTokenFixture() {

        const totalBidders = 50;
        const totalNFTAuctioned = 41;
        ...
        const auctionEndTime = Math.round(new Date().getTime() / 1000) + 500000;
        const mysteryContractAddress = await mystery.getAddress();
        const reservePrice = "0.4";
        const highestBidPrice = "0.5";
    ...
    it("winners not eligible to refund", async function() {
    ...
    it("after all participant claim and refund, admin can withdraw right amount of fund to recipient wallet address", async function() {
        ...
        console.log(afterWithdrawBalance - initialBalance)
